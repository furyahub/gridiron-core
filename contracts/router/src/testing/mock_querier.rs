...
use gridiron::pair::SimulationResponse;
...
impl WasmMockQuerier {
    ...
    pub fn with_gridiron_pairs(&mut self, pairs: &[(&String, &String)]) {
        self.gridiron_factory_querier = GridironFactoryQuerier::new(pairs);
    }
}
