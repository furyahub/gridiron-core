...
use crate::{
    ...
    MockToken, MockTokenBuilder, MockVestingBuilder, WKApp, GRIDIRON,
};
    ...
    C::QueryT: CustomQuery + DeserializeOwned + 'static,
{
    ...
    pub fn instantiate(self) -> MockGenerator<B, A, S, C, X, D, I, G> {
        ...
        let grid_token = MockTokenBuilder::new(&self.app, "GRID").instantiate();
        let grid_token_info = grid_token.asset_info();
        let vesting = MockVestingBuilder::new(&self.app)
            .with_grid_token(&grid_token_info)
            .instantiate();
        ...
        grid_token.mint(&gridiron, Uint128::new(1_000_000_000_000));
    ...
    C::QueryT: CustomQuery + DeserializeOwned + 'static,
{
    ...
    pub fn grid_token_info(&self) -> AssetInfo {
        let res: Config = self
            .app
            .borrow()
            .wrap()
