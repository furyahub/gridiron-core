...
/// ```
/// # use gridiron::factory::PairType::{Custom, Stable, Xyk};
/// Xyk {};
/// Stable {};
...
pub struct InstantiateMsg {
    ...
    pub owner: String,
    /// CW1 whitelist contract code id used to store 3rd party rewards for staking Gridiron LP tokens
    pub whitelist_code_id: u64,
...
pub enum ExecuteMsg {
    ...
    UpdateConfig {
        ...
        /// Contract address where Lp tokens can be auto_staked after someone provides liquidity in an incentivized Gridiron pool
...
pub struct ConfigResponse {
    ...
    pub fee_address: Option<Addr>,
    /// Address of contract used to auto_stake LP tokens for Gridiron pairs that are incentivized
    pub generator_address: Option<Addr>,
    /// CW1 whitelist contract code id used to store 3rd party rewards for staking Gridiron LP tokens
    pub whitelist_code_id: u64,
    /// The address of the contract that contains the coins and their accuracy
